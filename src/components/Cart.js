...
class Cart extends Component {
  ...
  render(){
    ...
    if (this.props.orderTotal === 0) {
      return (
        <Fragment>
          <NavBar orderTotal={this.props.orderTotal} changeCurrency={this.props.changeCurrency} currency={this.props.currency}/>
        ...
        <Container id='page-container'>
          ...
          <Container id='order-box'>
            ...
            <Container id='cart-total'>
              <p>Order: <strong>{formatPrice(totalPizzaPrice, this.props.currency)}</strong></p>
              <p>Delivery (free over {formatPrice(1200, this.props.currency)}): <strong>{formatPrice(deliveryPrice, this.props.currency)}</strong></p>
              <p>Total: <strong>{formatPrice(checkoutTotal, this.props.currency)}</strong></p>

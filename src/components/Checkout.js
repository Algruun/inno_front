        ...
        <Container id='page-container'>
          ...
          <Grid stackable columns={2}>
            ...
            <Grid.Column width={6}>
              ...
              <Button color='teal' size='large' id='checkout-btn' onClick={this.handleSubmit}>Place Order & Pay {formatPrice(this.props.checkoutTotal, this.props.currency)} </Button>
            </Grid.Column>
          </Grid>
        </Container>
      </Fragment>
